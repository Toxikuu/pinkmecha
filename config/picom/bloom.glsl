...
uniform float light_brightness = 0.8;// Scaling value for the brightness of the bloom effect

uniform float base_brightness = 1.1;// Scaling value for the brightness of the bright pixels
...
float blur_kernel[15][15] = kernel3;// Kernel to use for the gaussian blur
